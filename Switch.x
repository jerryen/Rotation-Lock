...
@interface RotationLockSwitch : NSObject <FSSwitchDataSource>
@end
...
{
	%orig();
	[[FSSwitchPanel sharedPanel] stateDidChangeForSwitchIdentifier:[NSBundle bundleForClass:[RotationLockSwitch class]].bundleIdentifier];
}
